...
x = get_embeddings.batch(mat=x, image_paths=image_path,
...
unCLIP_evolution.generate_image(
    model_path=unclip_model_path, embedding=embedding, image_name=image_name)
...
for index in indices:
    ...
    unCLIP_evolution.generate_image(
        model_path=unclip_model_path, embedding=new_embed, image_name=image_name)
